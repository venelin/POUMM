...
```{r fitPOUMM-1, results="hide", message=FALSE, warning=FALSE, eval=!useCachedResults}
...
```{r fitPOUMM-2, results="hide", eval=!useCachedResults}
...
```{r saveCache, include=FALSE, eval=!useCachedResults}
save(gBM, zBM, e, fitPMM_on_zBM, fitPOUMM_on_zBM, specPMM, fitPMM, fitPOUMM2, fitPOUMM, g, z, tree, file="UserGuideCache.RData")
```
...
```{r saveCache2, include=FALSE, eval=!useCachedResults}
save(gBM, zBM, e, fitPMM_on_zBM, fitPOUMM_on_zBM, specPMM, fitPMM, 
     fitPOUMM2, fitPOUMM, g, z, tree, specH2tMean, fitH2tMean, 
...
```{r saveCache3, include=FALSE, eval=!useCachedResults}
save(gBM, zBM, e, fitPMM_on_zBM, fitPOUMM_on_zBM, specPMM, fitPMM, 
     fitPOUMM2, fitPOUMM, g, z, tree, specH2tMean, fitH2tMean,
     file="UserGuideCache.RData")
```
