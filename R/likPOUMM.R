...
likPOUMMGivenTreeVTipsC <- function(
  ...
  if(anyNA(c(alpha, theta, sigma, sigmae))) { # case 9 and 10
    ...
    abc <- integrator$abc(alpha, theta, sigma, sigmae)
...
#' for the given coefficients abc, and parameters theta, g0 and g0Prior. This 
