...
Mac OS X El Capitan using clang compiler (see the section [Parallel execution](#Parallel) 
below).
...
load(system.file("extdata", "UserGuideCache.RData", package="POUMM"))
```
...
if(!useCachedResults) {
  ...
  save(g, z, tree, e, 
       ...
       file=system.file("extdata", "UserGuideCache.RData", package="POUMM"))
} 
