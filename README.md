...
For a basic introduction to the model parameters and the package, read the vignette [Get started](./articles/UserGuide.html). More advanced topics, such as parametrizations and interpretations of the model fit are covered in the other package [vignettes](./articles/index.html) and in the package help-pages, e.g. `?POUMM`, `?specifyPOUMM`, `?summary.POUMM`, `?plot.POUMM`.

Installing the R-package
========================

Read the section [Installing the POUMM R-package](./articles/UserGuide.html#Installing) in [Get started](./articles/UserGuide.html).
